...
ALLOWED_HOSTS = getenv('DJANGO_ALLOWED_HOSTS', '127.0.0.1,locahost').split(',')
...
SITE_NAME = getenv('SITE_NAME', 'Django Backend')
...
DJOSER = {
    ...
    'TOKEN_MODEL': None,
    'SOCIAL_AUTH_ALLOWED_REDIRECT_URIS': getenv('SOCIAL_AUTH_ALLOWED_REDIRECT_URIS').split(',')
}
